...
import StatusDropdown from '../common/custom-component/dropdowns/sale-order-status';
...
const WrappedListSaleOrders = Form.create({
  name: 'list_sale_orders',
})(ListSaleOrders);

export default WrappedListSaleOrders;
