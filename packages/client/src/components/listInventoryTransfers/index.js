...
function ListInventoryTransfers(props) {
  const pagination = {
    current: 0,
...
ListInventoryTransfers.propTypes = {
...
const WrappedListInventoryTransfers = Form.create({
  name: 'list_inventory_transfer',
})(ListInventoryTransfers);

export default WrappedListInventoryTransfers;
