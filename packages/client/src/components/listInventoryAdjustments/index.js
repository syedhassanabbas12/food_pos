...
function ListInventoryAdjustments(props) {
  const pagination = {
    current: 0,
  ...
  return (
    <Card
      ...
      bordered={false}
      extra={
        <Link to={`/addinventoryadjustment`}>
          <Button
            style={{ marginLeft: 8 }}
...
ListInventoryAdjustments.propTypes = {
...
const WrappedListInventoryAdjustments = Form.create({
  name: 'list_inventory_adjstments',
})(ListInventoryAdjustments);

export default WrappedListInventoryAdjustments;
