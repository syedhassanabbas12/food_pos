...
import VendorDropdown from '../common/custom-component/dropdowns/vendor';
...
function AddVendorAuthorization(props) {
    ...
    return (
      <TabPane tab='Custom' key='custom'>
        <Row gutter={24}>
          ...
          <Col xs={24} sm={12} md={6} lg={6}>
            <Form.Item label='Vendor Bill#'>
              {
                <>
                  {getFieldDecorator('vendorbillno', {
                    initialValue: null,
                  })(<Input disabled />)}
                </>
              }
...
AddVendorAuthorization.propTypes = {
...
const WrappedAddVendorAuthorization = Form.create({
  name: 'add_vendor_return_authorization',
})(AddVendorAuthorization);

export default WrappedAddVendorAuthorization;
