...
function AddVendorCredit(props) {
  ...
  const goBack = () => {
    ...
    else history.push('/vendorcredits');
  };
...
const WrappedAddVendorCredit = Form.create({
  name: 'add_vendor_credit',
})(AddVendorCredit);

export default WrappedAddVendorCredit;
