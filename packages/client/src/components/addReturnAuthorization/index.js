...
function AddReturnAuthorization(props) {
...
AddReturnAuthorization.propTypes = {
...
const WrappedAddReturnAuthorization = Form.create({
  name: 'add_return_authorization',
})(AddReturnAuthorization);

export default WrappedAddReturnAuthorization;
