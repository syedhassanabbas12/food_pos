...
function ListVendorReturns(props) {
  const pagination = {
    current: 0,
...
const WrappedListVendorReturns = Form.create({
  name: 'list_vendor_returns',
})(ListVendorReturns);

export default WrappedListVendorReturns;
