...
function ListReturnAuthorizations(props) {
  const pagination = {
    current: 0,
...
ListReturnAuthorizations.propTypes = {
...
const WrappedListReturnAuthorizations = Form.create({
  name: 'list_credit_memos',
})(ListReturnAuthorizations);

export default WrappedListReturnAuthorizations;
